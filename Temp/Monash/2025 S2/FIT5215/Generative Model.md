...
- Training 𝐺 is to minimize or fool the discriminator 𝐷, i.e., minimize $1-D(G(z))$ to 0, which means maximise D(G(z)) to 1
...
## U-net
在扩散模型的**反向过程 (Reverse Process)** 中，这个 U-Net 扮演着一个**噪声预测器**的角色
