...
**Step 1:** 
$¬R(x) ∨ T(g₁(x))$ applies to $P(x) ∨ R(z)$: 
$P(x) ∨ R(x)$
**Step 2:** Derive $R(z)$ with $P(x) ∨ R(z)$
- Unify: $x=c$
- Key that we do not know: $T(g_1(g_1(c)))$

C1:   ¬R(x) ∨ T(c1)                   (from clause 1)

C2a:  P(x) ∨ R(z)                     (from clause 2)
C2b:  ¬T(g2(x)) ∨ Q(f2(x))           (from clause 2)

C3a:  ¬P(x) ∨ T(w)                    (from clause 3)
C3b:  ¬Q(f3(w)) ∨ P(x)               (from clause 3)

C4:   ¬R(f4(x)) ∨ ¬Q(x)               (from clause 4)

C5:   ¬U(x) ∨ P(x) ∨ ¬T(f(x))         (from clause 5)

C6a:  Q(a)                            (from clause 6)
C6b:  ¬U(a)                           (from clause 6)

C7:   ¬P(x) ∨ Q(y) ∨ S(x,y)           (from clause 7)

Cneg: ¬P(b)                           (negated goal)
